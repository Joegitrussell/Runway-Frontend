...
function BudgetPage() {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("h2", {
      className: "text-5xl col text-black font-bold",
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        id: "base-level",
        className: "flex gap-5 bg-white p-2 rounded-md w-64 h-10 justify-between text-black",
